...
<head>
    ...
    <link rel="stylesheet" href="public/external/slick/slick.css">
    <link rel="stylesheet" href="public/external/slick/slick-theme.css">
    <link rel="stylesheet" href="public/external/magnific-popup/magnific-popup.css">
    <link rel="stylesheet" href="public/external/nouislider/nouislider.css">
    <link rel="stylesheet" href="public/external/bootstrap-select/bootstrap-select.css">
    <!-- SLIDER REVOLUTION 4.x CSS SETTINGS -->
    <link rel="stylesheet" type="text/css" href="public/external/rs-plugin/css/settings.css" media="screen" />
    <!-- Custom CSS -->
    ...
    <!-- Head Libs -->
    <!-- Modernizr -->
    <script src="public/external/modernizr/modernizr.js"></script>
</head>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-sm-4 col-md-4 col-lg-6 col-xl-7">
                        <!-- logo start -->
                        <a href="?mod=home"><img class="logo replace-2x img-responsive" src="public/images/logo.png" alt="" /> </a>
                        <!-- logo end -->
                    </div>
                                ...
                                <div class="account link-inline">
                                    <div class="dropdown text-right">
                                        ...
                                        <ul class="dropdown-menu dropdown-menu--xs-full">
                                            ...
                                            <li>
                                                <a href="?mod=login"><span class="icon icon-person_add">
                                                    </span>Tạo tài khoản
                                                </a>
                                            </li>
                                            <?php }?>
                                        ...
                                        <div class="dropdown-menu dropdown-menu--xs-full slide-from-top" role="menu">
                                            <div class="container">
                                                ...
                                                <div class="cart__bottom">
                                                    ...
                                                    <a href="?mod=checkout" class="btn btn--ys btn-checkout">Thanh toán<span class="icon icon--flippedX icon-reply"></span></a>
                                                    <a href="?mod=cart" class="btn btn--ys"><span class="icon icon-shopping_basket"></span> Xem giỏ hàng</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
        ...
        $('#login-form-modal').submit(function(e) {
            ...
            $.ajax({
                ...
                success : function(res) {
                    ...
                    if (data === false) {
                        $('#error-m i').text('Đăng nhập thất bại!!');
                    } else {
                        $('#error-m i').text('');
