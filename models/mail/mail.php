...
function send_email($email_recive, $name, $contents, $subject) {
	...
	$mail->Username = "langphan2@gmail.com"; // Tên đăng nhập tài khoản Gmail
	$mail->Password = "kqczecevkhivukbm"; //Mật khẩu của gmail
	$mail->SetFrom("langphan2@gmail.com", "Your Store"); // Thông tin người gửi
	$mail->AddReplyTo("langphan2@gmail.com", "Your Store"); // Ấn định email sẽ nhận khi người dùng reply lại.
